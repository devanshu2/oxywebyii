...
<body> 
    ...
    <div id="content-outer">
        <!-- start content -->
        <div id="content">
            <div id="page-heading"><h1>Active Recipe</h1></div>
                            ...
                            <form id="recipe-add-update" enctype="multipart/form-data">
                                ...
                                <table id="id-form" border="0" width="100%" cellpadding="5" cellspacing="0">
                                    <tr>
                                        ...
                                        <td><input type="text" name="rp_name" value="<?php echo htmlentities($recipe['rp_name']); ?>" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br/>
                                            <img src="<?php echo CommonFunctions::getCroppedRecipeImage($recipe['rp_image_url'], 100, 100, 1) ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input class="form-submit" type="submit" name="action_type" value="Delete" />
                                        </td>
                                    </tr>
                                </table>
                            </form>
